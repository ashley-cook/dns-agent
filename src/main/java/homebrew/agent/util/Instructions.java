...
public class Instructions implements Opcodes {
    ...
    public static boolean isRealNode(AbstractInsnNode ain) {
        return ain != null && ain.getOpcode() != -1 && ain.getOpcode() != NOP;
    }
    ...
    public static boolean isPseudoInsnNode(AbstractInsnNode node) {
        return node instanceof FrameNode || node instanceof LabelNode || node instanceof LineNumberNode;
    }
